        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="categories.html"><i class="fa fa-fw fa-tag"></i> Categorías</a>
                    </li>
                    <li>
                        <a href="products.html"><i class="fa fa-fw fa-cube"></i> Productos</a>
                    </li>
                    <li>
                        <a href="orders.html"><i class="fa fa-fw fa-file-text"></i> Pedidos</a>
                    </li>
                    <li>
                        <a href="users.html"><i class="fa fa-fw fa-user"></i> Usuarios</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
